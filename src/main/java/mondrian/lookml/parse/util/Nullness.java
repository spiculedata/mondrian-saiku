...
// Apache-2.0. Re-packaged into mondrian.lookml.parse.util for the LookML->M4
// importer (issue #98). No functional changes.
//
package mondrian.lookml.parse.util;
...
/**
 * Utilities for managing whether the compiler thinks that a reference or
 * collection may contain null values.
 *
 * <p>The methods in this class allow you to cast a nullable reference to a
 * non-nullable one. The class allows us remove the {@code checker-qual} runtime
 * dependency, and helps IDEs to see the resulting types of {@code castNonNull}
 * better.
 *
 * <p>This is an internal class, and it is not meant to be used as a public API.
 */
class Nullness {
  private Nullness() {}
