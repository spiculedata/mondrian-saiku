...
public class RolapSchema extends OlapElementBase implements Schema {
    ...
    public static class PhysSchema {
        ...
        /**
         * Returns an unmodifiable view of every link registered in this
         * schema, irrespective of hard/soft designation. Used by the
         * Calcite MV shape enumerator to locate fact→dim FK joins
         * without relying on the (currently empty) {@code hardLinksFrom}
         * index — schema-level {@code &lt;Link&gt;} declarations are
         * added with {@code hard=false}, see
         * {@code RolapSchemaLoader.addLink}.
         */
        public Set<PhysLink> getLinks() {
